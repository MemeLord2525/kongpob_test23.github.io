...
$query_Rec_register = "SELECT * FROM kongpob_system01";
$Rec_register = mysql_query($query_Rec_register, $mysqli) or die(mysql_error());
$row_Rec_register = mysql_fetch_assoc($Rec_register);
$totalRows_Rec_register = mysql_num_rows($Rec_register);
?>
<?php
...
if (isset($_POST['username'])) {
  ...
  $LoginRS__query=sprintf("SELECT name_std, code_std FROM kongpob_system01 WHERE name_std=%s AND code_std=%s",
...
<body>
    <div class="container">
      ...
      <div class="signup-link"><a href="register.php">REGISTER</a></div>
</div>
</body>
</html>
<?php
mysql_free_result($Rec_register);
?>
